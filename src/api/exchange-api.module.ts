...
import { InstanceTypesController } from './controllers/instance-types.controller';
import { InstanceVersionsController } from './controllers/instance-versions.controller';
...
import { FilesService } from './services/special/files.service';
...
@Module({
  ...
  controllers: [
    ...
    CatalogBrandCollectionsController,
    CatalogBrandsController,
    CatalogMetatypePropertiesController,
    CatalogProductOffersController,
    CatalogProductsController,
    CatalogPropertiesController,
    CatalogTypesController,
    CatalogsController,
    CollectionPropertyValuesController,
    CurrenciesController,
    FileLoadTasksController,
    InstanceTypesController,
    InstanceVersionsController,
    MetatypesController,
    OfferPricesController,
    OfferPropertyValuesController,
    OptionsPropertyValuesController,
    PriceTypesController,
    ProductPricesController,
    ProductPropertyValuesController,
    ProductRelationsController,
    ProductsRelationKindsController,
    PropertyInTypesController,
    PropertyPrimitivesController,
    PropertyTypesController,
    RatesController,
    RatesSourcesController,
    RelationsController,
    StoresController,
    TypePropertyValuesController,
  ...
  providers: [
    ...
    ActorsService,
    ApiKeysService,
    BrandPropertyValuesService,
    CatalogBrandCollectionsService,
    CatalogBrandsService,
    CatalogMetatypePropertiesService,
    CatalogProductOffersService,
    CatalogProductsService,
    CatalogPropertiesService,
    CatalogTypesOverloadService,
    CatalogTypesService,
    CatalogsService,
    CollectionPropertyValuesService,
    CompaniesService,
    CurrenciesService,
    FileLoadTasksService,
    FilesService,
    InstanceTypesService,
    InstanceVersionsService,
    MetatypesService,
    OfferAmountsService,
    OfferPricesService,
    OfferPropertyValuesService,
    OoRelationValuesService,
    OpRelationValuesService,
    OptionsPropertyValuesService,
    PoRelationValuesService,
    PpRelationValuesService,
    PriceTypesService,
    ProductPricesService,
    ProductPropertyValuesService,
    ProductRelationsService,
    ProductsRelationKindsService,
    PropertyInTypesService,
    PropertyPrimitivesService,
